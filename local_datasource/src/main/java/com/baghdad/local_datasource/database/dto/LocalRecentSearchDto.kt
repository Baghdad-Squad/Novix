...
import com.baghdad.local_datasource.database.dto.LocalRecentSearchDto.Companion.RECENTLY_SEARCH_TABLE_NAME
import com.baghdad.repository.model.RecentSearchDto

@Entity(tableName = RECENTLY_SEARCH_TABLE_NAME)
data class LocalRecentSearchDto(
...
fun LocalRecentSearchDto.toDto(): RecentSearchDto {
