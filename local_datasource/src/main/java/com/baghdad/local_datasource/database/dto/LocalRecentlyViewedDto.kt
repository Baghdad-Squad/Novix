...
import com.baghdad.local_datasource.database.dto.LocalRecentlyViewedDto.Companion.RECENTLY_VIEWED_TABLE_NAME
import com.baghdad.repository.model.RecentlyViewedDto


@Entity(tableName = RECENTLY_VIEWED_TABLE_NAME)
data class LocalRecentlyViewedDto(
    @PrimaryKey
...
fun LocalRecentlyViewedDto.toDto(): RecentlyViewedDto {
